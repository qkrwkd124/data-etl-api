...
from app.schemas.eiu_schemas import DataType
class EconomicData(Base):
    ...
    # 연도별 데이터 (19년부터 51년까지)
    eiu_year1 = Column(String(300), nullable=True, default=DataType.UNKNOWN.value,comment="2001년")
    eiu_year2 = Column(String(300), nullable=True, comment="2002년")
    eiu_year3 = Column(String(300), nullable=True, comment="2003년")
    eiu_year4 = Column(String(300), nullable=True, comment="2004년")
    eiu_year5 = Column(String(300), nullable=True, comment="2005년")
    eiu_year6 = Column(String(300), nullable=True, comment="2006년")
    eiu_year7 = Column(String(300), nullable=True, comment="2007년")
    eiu_year8 = Column(String(300), nullable=True, comment="2008년")
    eiu_year9 = Column(String(300), nullable=True, comment="2009년")
    eiu_year10 = Column(String(300), nullable=True, comment="2010년")
    eiu_year11 = Column(String(300), nullable=True, comment="2011년")
    eiu_year12 = Column(String(300), nullable=True, comment="2012년")
    eiu_year13 = Column(String(300), nullable=True, comment="2013년")
    eiu_year14 = Column(String(300), nullable=True, comment="2014년")
    eiu_year15 = Column(String(300), nullable=True, comment="2015년")
    eiu_year16 = Column(String(300), nullable=True, comment="2016년")
    eiu_year17 = Column(String(300), nullable=True, comment="2017년")
    eiu_year18 = Column(String(300), nullable=True, comment="2018년")
    eiu_year19 = Column(String(300), nullable=True, comment ="2019년")
    eiu_year20 = Column(String(300), nullable=True, comment="2020년")
    eiu_year21 = Column(String(300), nullable=True, comment="2021년")
